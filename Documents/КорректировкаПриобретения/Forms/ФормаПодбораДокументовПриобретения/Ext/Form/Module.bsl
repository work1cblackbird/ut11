...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОписаниеТиповДокументаРеализации = Метаданные.Документы.КорректировкаПриобретения.ТабличныеЧасти.КорректировкаЗадолженности.Реквизиты.ДокументПриобретения.Тип;
