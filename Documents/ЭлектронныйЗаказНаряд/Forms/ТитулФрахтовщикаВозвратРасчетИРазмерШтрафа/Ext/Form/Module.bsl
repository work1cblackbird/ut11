...
&НаКлиенте
Процедура ТитулФрахтовщикаВозвратРасчетИРазмерШтрафаПередУдалением(Элемент, Отказ)
...
Процедура СсылкаВалютаШтрафаПриИзменении(Элемент)
	...
	ОбменСГИСЭПДКлиентСервер.ЗаполнитьРеквизитыПоСсылке(Элемент, ЭтотОбъект, Элементы.ТитулФрахтовщикаВозвратРасчетИРазмерШтрафа.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулФрахтовщикаВозвратРасчетИРазмерШтрафаПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
