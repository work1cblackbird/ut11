...
&НаКлиенте
Процедура ТитулФрахтовщикаСведенияОПутевыхЛистахПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулФрахтовщикаСведенияОПутевыхЛистахПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
