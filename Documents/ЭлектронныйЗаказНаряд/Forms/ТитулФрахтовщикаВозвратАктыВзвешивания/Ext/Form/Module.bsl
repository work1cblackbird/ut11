...
&НаКлиенте
Процедура ТитулФрахтовщикаВозвратАктыВзвешиванияПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ЗаполнитьТитулФрахтовщикаВозвратАктыВзвешиванияРеквизитыСторонНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулФрахтовщикаВозвратАктыВзвешивания.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулФрахтовщикаВозвратАктыВзвешиванияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	Если Поле.Имя = "ЗаполнитьТитулФрахтовщикаВозвратАктыВзвешиванияРеквизитыСторон" Тогда
...
&НаКлиенте
Процедура ТитулФрахтовщикаВозвратАктыВзвешиванияПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
