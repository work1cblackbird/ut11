...
&НаКлиенте
Процедура ТитулФрахтователяСведенияОбОпасномГрузеПередУдалением(Элемент, Отказ)
...
Процедура СсылкаДОПОГПриИзменении(Элемент)
	...
	ОбменСГИСЭПДКлиентСервер.ЗаполнитьРеквизитыПоСсылке(Элемент, ЭтотОбъект, Элементы.ТитулФрахтователяСведенияОбОпасномГрузе.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулФрахтователяСведенияОбОпасномГрузеПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
