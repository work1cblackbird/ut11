...
Процедура ХранимыеДанныеВодительНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулФрахтовщикаВодитель.ТекущиеДанные);
...
Процедура ХранимыеДанныеВодительПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулФрахтовщикаВодитель.ТекущиеДанные.ХранимыеДанныеВодитель;
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулФрахтовщикаВодитель.ТекущиеДанные);
...
&НаКлиенте
Процедура ЗаполнитьТитулФрахтовщикаСведенияОПутевыхЛистахНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
Процедура ТитулФрахтовщикаСведенияОВодителеВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ЗаполнитьТитулФрахтовщикаСведенияОПутевыхЛистах" Тогда
