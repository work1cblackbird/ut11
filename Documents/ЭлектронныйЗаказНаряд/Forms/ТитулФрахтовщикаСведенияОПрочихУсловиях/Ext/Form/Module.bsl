...
&НаКлиенте
Процедура ТитулФрахтовщикаСведенияОПрочихУсловияхПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ЗаполнитьТитулФрахтовщикаКоммерческиеИИныеАктыНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулФрахтовщикаСведенияОПрочихУсловиях.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулФрахтовщикаСведенияОПрочихУсловияхВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	Если Поле.Имя = "ЗаполнитьТитулФрахтовщикаКоммерческиеИИныеАкты" Тогда
...
&НаКлиенте
Процедура ТитулФрахтовщикаСведенияОПрочихУсловияхПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
