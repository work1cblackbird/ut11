...
&НаКлиенте
Процедура ТитулПеревозчикаВыдачаРасчетыШтрафовПередУдалением(Элемент, Отказ)
...
Процедура СсылкаВалютаШтрафаПриИзменении(Элемент)
	...
	ОбменСГИСЭПДКлиентСервер.ЗаполнитьРеквизитыПоСсылке(Элемент, ЭтотОбъект, Элементы.ТитулПеревозчикаВыдачаРасчетыШтрафов.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулПеревозчикаВыдачаРасчетыШтрафовПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
