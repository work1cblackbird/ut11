...
&НаКлиенте
Процедура ТитулПеревозчикаЗаменыСведенияОСпециальныхУсловияхДвиженияПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулПеревозчикаЗаменыСведенияОСпециальныхУсловияхДвиженияПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
