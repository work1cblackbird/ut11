...
&НаКлиенте
Процедура ТитулГрузополучателяРасчетыШтрафовПередУдалением(Элемент, Отказ)
...
Процедура СсылкаВалютаШтрафаПриИзменении(Элемент)
	...
	ОбменСГИСЭПДКлиентСервер.ЗаполнитьРеквизитыПоСсылке(Элемент, ЭтотОбъект, Элементы.ТитулГрузополучателяРасчетыШтрафов.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулГрузополучателяРасчетыШтрафовПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
