...
&НаКлиенте
Процедура ТитулУказаниеПереадресРеквизитыСторонДокументаПодтверждающийОтгрузкуПередУдалением(Элемент, Отказ)
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулУказаниеПереадресРеквизитыСторонДокументаПодтверждающийОтгрузку.ТекущиеДанные);
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументОткрытие(Элемент, СтандартнаяОбработка)
	...
	Если ТипЗнч(Элементы.ТитулУказаниеПереадресРеквизитыСторонДокументаПодтверждающийОтгрузку.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент) <> Тип("СправочникСсылка.ХранимыеДанныеЭПД") Тогда
		СтандартнаяОбработка = Ложь;
		ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулУказаниеПереадресРеквизитыСторонДокументаПодтверждающийОтгрузку.ТекущиеДанные, Ложь);
	КонецЕсли;
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулУказаниеПереадресРеквизитыСторонДокументаПодтверждающийОтгрузку.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	...
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулУказаниеПереадресРеквизитыСторонДокументаПодтверждающийОтгрузку.ТекущиеДанные);
...
&НаКлиенте
Процедура ТитулУказаниеПереадресРеквизитыСторонДокументаПодтверждающийОтгрузкуПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
