...
&НаКлиенте
Процедура ТитулГрузоотправителяДокументПолномочийПереадресовкиРеквизитыСторонПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ХранимыеДанныеТитулГрузоотправителяСторонаДокументаПолномочийПереадресовкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулГрузоотправителяДокументПолномочийПереадресовкиРеквизитыСторон.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ХранимыеДанныеТитулГрузоотправителяСторонаДокументаПолномочийПереадресовкиПриИзменении(Элемент)
	
	ЗначениеРеквизита = Элементы.ТитулГрузоотправителяДокументПолномочийПереадресовкиРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулГрузоотправителяДокументПолномочийПереадресовкиРеквизитыСторон.ТекущиеДанные);
...
&НаКлиенте
Процедура ХранимыеДанныеТитулГрузоотправителяСторонаДокументаПолномочийПереадресовкиАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ТитулГрузоотправителяДокументПолномочийПереадресовкиРеквизитыСторонПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
