...
&НаКлиенте
Процедура ТитулГрузополучателяАктВзвешиванияРеквизитыСторонПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ХранимыеДанныеТитулГрузополучателяСторонаАктаВзвешиванияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулГрузополучателяАктВзвешиванияРеквизитыСторон.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ХранимыеДанныеТитулГрузополучателяСторонаАктаВзвешиванияПриИзменении(Элемент)
	
	ЗначениеРеквизита = Элементы.ТитулГрузополучателяАктВзвешиванияРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулГрузополучателяАктВзвешиванияРеквизитыСторон.ТекущиеДанные);
...
&НаКлиенте
Процедура ХранимыеДанныеТитулГрузополучателяСторонаАктаВзвешиванияАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ТитулГрузополучателяАктВзвешиванияРеквизитыСторонПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
