...
&НаКлиенте
Процедура ТитулПереадресовкаСведенияОбОтметкахПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулПереадресовкаСведенияОбОтметкахПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
