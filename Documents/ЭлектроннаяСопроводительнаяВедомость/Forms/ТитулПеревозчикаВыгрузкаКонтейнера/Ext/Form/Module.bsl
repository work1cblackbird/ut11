...
&НаКлиенте
Процедура ПредставлениеТитулПеревозчикаАдресВыгрузкиАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ПредставлениеТитулПеревозчикаАдресВыгрузкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ПредставлениеТитулПеревозчикаАдресВыгрузкиОбработкаВыбора(Элемент, Результат, СтандартнаяОбработка)
