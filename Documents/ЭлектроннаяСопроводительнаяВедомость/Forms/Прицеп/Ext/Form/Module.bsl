...
&НаКлиенте
Процедура ТитулПеревозчикаПрицепОснованиеВладенияРеквизитыСторонПередУдалением(Элемент, Отказ)
...
Процедура ХранимыеДанныеТитулПеревозчикаСторонаПодписавшаяДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ОснованиеВладенияРеквизитыСторон.ТекущиеДанные);
...
Процедура ХранимыеДанныеТитулПеревозчикаСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ОснованиеВладенияРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ОснованиеВладенияРеквизитыСторон.ТекущиеДанные);
...
&НаКлиенте
Процедура ТитулПеревозчикаПрицепОснованиеВладенияРеквизитыСторонПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
