...
&НаКлиенте
Процедура ТитулПеревозчикаОписаниеГрузаПередУдалением(Элемент, Отказ)
...
Процедура ХранимыеДанныеГрузНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулПеревозчикаОписаниеГруза.ТекущиеДанные);
...
Процедура ХранимыеДанныеГрузПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулПеревозчикаОписаниеГруза.ТекущиеДанные.ХранимыеДанныеГруз;
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулПеревозчикаОписаниеГруза.ТекущиеДанные);
...
&НаКлиенте
Процедура ЗаполнитьТитулПеревозчикаМаркировкаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ТитулПеревозчикаОписаниеГрузаВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	Если Поле.Имя = "ЗаполнитьТитулПеревозчикаМаркировка"
		Или Поле.Имя = "ЗаполнитьСведенияОбОпасномГрузе"
...
&НаКлиенте
Процедура ТитулПеревозчикаОписаниеГрузаПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
