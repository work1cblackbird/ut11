...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.СоставСегментовРетроБонусовКлиентов);
...
Функция ДобавитьКомандуОтчета(КомандыОтчетов, Параметры, КлючВарианта = "") Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.СоставСегментовРетроБонусовКлиентов)
	   И ПолучитьФункциональнуюОпцию("ИспользоватьРетроБонусыКлиентов")
	   И (ПолучитьФункциональнуюОпцию("ИспользоватьСегментыНоменклатуры") 
		...
		Если КлючВарианта = "СоставСегментовРетроБонусовКлиентовКонтекст" Тогда
			
			Представление = НСтр("ru = 'Состав сегментов (актуальные данные)'"); 
			
		ИначеЕсли КлючВарианта = "СоставСегментовРетроБонусовКлиентовПоДаннымДокументаКонтекст" Тогда
			
			Представление = НСтр("ru = 'Состав сегментов (данные документа)'");
			
		Иначе
			
			Представление = НСтр("ru = 'Состав сегментов ретро-бонусов клиентов'");
			
		КонецЕсли;
		
		КомандаОтчет.Менеджер = Метаданные.Отчеты.СоставСегментовРетроБонусовКлиентов.ПолноеИмя();
