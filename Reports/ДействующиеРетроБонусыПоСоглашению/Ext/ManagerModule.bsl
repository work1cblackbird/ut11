...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ДействующиеРетроБонусыПоСоглашению);
...
Функция ДобавитьКомандуОтчета(КомандыОтчетов, КлючВарианта = "") Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ДействующиеРетроБонусыПоСоглашению)
	   И ПолучитьФункциональнуюОпцию("ИспользоватьРетроБонусыКлиентов") Тогда
		
		КомандаОтчет = КомандыОтчетов.Добавить();
		Представление = НСтр("ru = 'Действующие ретро-бонусы по соглашению'");
		КомандаОтчет.Представление = Представление;
		КомандаОтчет.Менеджер = Метаданные.Отчеты.ДействующиеРетроБонусыПоСоглашению.ПолноеИмя();
