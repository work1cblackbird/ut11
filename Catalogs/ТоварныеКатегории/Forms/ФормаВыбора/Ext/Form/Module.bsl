...
Процедура УстановитьОтборПоТекущейСтрокеВидаНоменклатуры(ТекущаяСтрокаВида)
	ВладелецТоварныхКатегорий = ТекущаяСтрокаВида;
	РеквизитыВладельца        = ОбщегоНазначенияУТВызовСервера.ЗначенияРеквизитовОбъекта(ВладелецТоварныхКатегорий, "ТоварныеКатегорииОбщиеСДругимВидомНоменклатуры, ВладелецТоварныхКатегорий");
	
	Если РеквизитыВладельца.ТоварныеКатегорииОбщиеСДругимВидомНоменклатуры = Истина Тогда
		ВладелецТоварныхКатегорий = РеквизитыВладельца.ВладелецТоварныхКатегорий;
	КонецЕсли;
