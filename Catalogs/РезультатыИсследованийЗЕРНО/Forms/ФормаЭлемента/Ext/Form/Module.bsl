...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	ЭтоАктОтбораПроб = Не ЗначениеЗаполнено(Объект.АктОтбораПроб)
		Или ТипЗнч(Объект.АктОтбораПроб) = Тип("СправочникСсылка.АктыОтбораПробЗЕРНО");
	Элементы.АктОтбораПроб.Видимость      = ЭтоАктОтбораПроб;
	Элементы.АктОтбораПробДата.Видимость  = Не ЭтоАктОтбораПроб;
	Элементы.АктОтбораПробНомер.Видимость = Не ЭтоАктОтбораПроб;
	Элементы.НомерПробы.Видимость         = Не ЭтоАктОтбораПроб;
	
	Если Не ЭтоАктОтбораПроб Тогда
		РеквизитыАктаОтбораПроб = РеквизитыАктаОтбораПроб(Объект.АктОтбораПроб);
		Форма.АктОтбораПробНомер = РеквизитыАктаОтбораПроб.Номер;
		Форма.АктОтбораПробДата = РеквизитыАктаОтбораПроб.Дата;
	КонецЕсли;
	
КонецПроцедуры

&НаСервереБезКонтекста
Функция РеквизитыАктаОтбораПроб(АктОтбораПроб)
	
	Возврат ОбщегоНазначения.ЗначенияРеквизитовОбъекта(АктОтбораПроб, "Номер,Дата");
