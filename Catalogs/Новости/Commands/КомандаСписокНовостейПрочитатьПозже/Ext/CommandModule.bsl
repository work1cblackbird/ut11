...
// e1cib/command/Справочник.Новости.Команда.КомандаСписокНовостейПрочитатьПозже.
...
// e1cib/navigationpoint/ИнтернетПоддержкаПользователей/Справочник.Новости.Команда.КомандаСписокНовостейПрочитатьПозже.
...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ОбработкаНовостейКлиент.ОткрытьСписокНовостейПрочитатьПозже(
		ПараметрКоманды,
