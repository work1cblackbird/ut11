...
// e1cib/command/Справочник.Новости.Команда.КомандаСписокПомеченныхНовостей.
...
// e1cib/navigationpoint/ИнтернетПоддержкаПользователей/Справочник.Новости.Команда.КомандаСписокПомеченныхНовостей.
...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ОбработкаНовостейКлиент.ОткрытьСписокПомеченныхНовостей(
		ПараметрКоманды,
