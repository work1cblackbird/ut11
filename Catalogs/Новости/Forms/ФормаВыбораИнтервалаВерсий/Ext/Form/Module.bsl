...
Процедура ВерсияПриИзменении(Элемент)
	...
	ЭтотОбъект.Версия = ОбработкаНовостейКлиентСервер.ВнутреннееПредставлениеНомераВерсии(ЭтотОбъект.Версия);
...
Процедура ВерсияОТПриИзменении(Элемент)
	...
	ЭтотОбъект.ВерсияОТ = ОбработкаНовостейКлиентСервер.ВнутреннееПредставлениеНомераВерсии(ЭтотОбъект.ВерсияОТ);
	ЭтотОбъект.Версия = ЭтотОбъект.ВерсияОТ;
...
Процедура ВерсияДОПриИзменении(Элемент)
	...
	ЭтотОбъект.ВерсияДО = ОбработкаНовостейКлиентСервер.ВнутреннееПредставлениеНомераВерсии(ЭтотОбъект.ВерсияДО);
