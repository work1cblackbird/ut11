...
Функция РеквизитыОтветственныхЛицДокумента(ИмяДокумента) Экспорт
	...
	Для Каждого Реквизит Из МетаданныеДокумента.Реквизиты Цикл
		...
		Если НЕ Реквизит.Тип.СодержитТип(ТипРеквизита)
		 ИЛИ СтрНайти(НРег(Реквизит.Имя), "удалить") = 1 Тогда
			Продолжить;
		КонецЕсли;
...
Функция ЕстьРеквизитыОтветственныхЛицДокумента(ИмяДокумента) Экспорт
	...
	Возврат ОтветственныеЛицаПовтИсп.РеквизитыОтветственныхЛицДокумента(ИмяДокумента).Количество() > 0;
