...
//  см. СтруктураРазграниченияДоступаПользователя
...
//  * ПраваДоступа      - Массив из ПеречислениеСсылка.ПраваДоступаВЕТИС - массив значений перечисления "ПраваДоступаВЕТИС".
//  * Предприятия       - Массив из СправочникСсылка.ПредприятияВЕТИС - массив значений справочника "ПредприятияВЕТИС".
//  * Адреса            - Массив из Структура - массив структур с адресами зон ответственности.
//
...
// Параметры:
//  СНИЛС - Строка - СНИЛС
//  РазрешатьПустой - Булево - Разрешать пустой
// 
// Возвращаемое значение:
//  Булево - Это СНИЛС
...
// 
// Параметры:
//  УчетнаяЗапись - Строка - Учетная запись
//  РазрешенаЛатинница - Булево - Разрешена латинница
//  РазрешеныЦифры - Булево - Разрешены цифры
//  РазрешенаКириллица - Булево - Разрешена кириллица
//  РазрешеныСпецсимволы - Булево - Разрешены спецсимволы
//  РазрешенныеСпецсимволы - Строка - Разрешенные спецсимволы
// 
// Возвращаемое значение:
//  Булево - Это учетная запись
