...
Функция ПолучитьДатуПереходаНаВерсиюСПрочтенностью() Экспорт //АПК:1036 не проверять строку на орфографию.
	
	Возврат Константы.ДатаОбновленияНаВерсиюСПрочтенностью.Получить(); //АПК:1036 не проверять строку на орфографию.
