...
Процедура ПриЗагрузкеДанныхОВскрытияхАлкогольнойТарыИзККМ(ОфлайнОборудование, ДанныеОВскрытияхТары, Отказ, СообщениеОбОшибке) Экспорт
	...
	ПодключаемоеОборудованиеOfflineВызовСервераЛокализация.ЗагрузитьДанныеОВскрытияхТарыИзККМ(ОфлайнОборудование, ДанныеОВскрытияхТары, Отказ, СообщениеОбОшибке);
...
Процедура ФормаОбменСОфлайнОборудованиемПриСозданииНаСервере(Форма) Экспорт
	...
	Форма.Элементы.ЗагрузитьЧекиОФД.Видимость = Ложь;
	Форма.Элементы.ЗагрузитьОборотыОФД.Видимость = Ложь;
