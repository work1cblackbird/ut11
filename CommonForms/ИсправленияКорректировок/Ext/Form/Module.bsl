...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИсправленияДокумента = ИсправлениеДокументов.ИсправленияДокумента(ИсправляемыйДокумент);	
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(СписокИсправлений, "ИсправленияДокумента", ИсправленияДокумента);
