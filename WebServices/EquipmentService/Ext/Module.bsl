...
Функция PrepareFullPriceList(DeviceID, FullPriceList)
	
	ИдентификаторПередачи = МенеджерОфлайнОборудованияWebСервис.ПолучитьИдентификаторПередачиПрайсЛиста(DeviceID, FullPriceList);
	Возврат ИдентификаторПередачи;
